...
# Ответ покупателю из чёрного списка (ни продажи, ни кодов/данных не выдаём).
BLOCKED_BUYER_MESSAGE = (
    '🚫 Извините, выдача для вашего аккаунта приостановлена.\n'
    'Система зафиксировала признаки попытки кражи аккаунта, поэтому коды и данные '
    'не выдаются. Если считаете это ошибкой — вызовите админа командой !admin.'
)
